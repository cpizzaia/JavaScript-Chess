...
Chess.Pawn.prototype.toQueen = function() {
  ...
  this.board.grid[x][y] = new Chess.Queen(this.color, this.board, this.position);
...
Chess.Pawn.prototype.toBishop = function() {
  var x = this.currentPosition[0];
  var y = this.currentPosition[1];
  this.board.grid[x][y] = new Chess.Bishop(this.color, this.board, this.position);
  Chess.display.clearPromotion();
};
...
Chess.Pawn.prototype.toKnight = function() {
  var x = this.currentPosition[0];
  var y = this.currentPosition[1];
  this.board.grid[x][y] = new Chess.Knight(this.color, this.board, this.position);
  Chess.display.clearPromotion();
};
...
Chess.Pawn.prototype.toRook = function() {
  var x = this.currentPosition[0];
  var y = this.currentPosition[1];
  this.board.grid[x][y] = new Chess.Rook(this.color, this.board, this.position);
  Chess.display.clearPromotion();
};
